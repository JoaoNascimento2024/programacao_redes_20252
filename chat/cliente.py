...
def enviar_mensagem():
    ...
    try:
        ...
        CTkMessagebox(title="Erro", message="Erro no envio de mensagem", 
                      icon="warning")
...
def conectar():
    ...
    if nome_valor is None or nome_valor == "":
        CTkMessagebox(title="Erro", message="Antes, digite seu nome", 
                      icon="warning")
        return    
    ...
    try:
        ...
        CTkMessagebox(title="Erro", message="Erro na conexão", 
                      icon="warning")
